...
const LISTINGS = [
  {
    ...
    gallery: [
      // ── Swap these URLs with your real listing photos ──
      { url: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200&q=85", label: "Living Room" },
      { url: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&q=85", label: "Kitchen" },
      { url: "https://images.unsplash.com/photo-1586105251261-72a756497a11?w=1200&q=85", label: "Bedroom" },
      { url: "https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=1200&q=85", label: "Bathroom" },
      { url: "https://images.unsplash.com/photo-1600607688969-a5bfcd646154?w=1200&q=85", label: "Juliet Balcony" },
      { url: "https://images.unsplash.com/photo-1613545325278-f24b0cae1224?w=1200&q=85", label: "Building Rooftop" },
    ],
