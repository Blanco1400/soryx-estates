...
const LISTINGS = [
  {
    ...
    img: "https://i.imgur.com/2A2NeGs.jpg",
    gallery: [
      { url: "https://i.imgur.com/2A2NeGs.jpg", label: "Living Room" },
      { url: "https://i.imgur.com/TQqASlS.jpg", label: "Loft" },
      { url: "https://i.imgur.com/tKAvT2O.jpg", label: "Bedroom" },
      { url: "https://i.imgur.com/5HoomBA.jpg", label: "Dining Area" },
      { url: "https://i.imgur.com/BeNVtyu.jpg", label: "Kitchen" },
      { url: "https://i.imgur.com/KbBfcuc.jpg", label: "Bathroom" },
      { url: "https://i.imgur.com/c6GeV3Q.jpg", label: "Entrance" },
      { url: "https://i.imgur.com/iuOf6Xp.jpg", label: "Hallway" },
      { url: "https://i.imgur.com/imXK3Kb.jpg", label: "Rooftop Lounge" },
      { url: "https://i.imgur.com/sCqDy7m.jpg", label: "Rooftop" },
      { url: "https://i.imgur.com/ugMIr5p.jpg", label: "Gym" },
    ],
